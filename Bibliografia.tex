\begin{thebibliography}{99}
	...
	\bibitem{bib:AlgebraPostGrado}MARTIN, Isaacs. \textit{Algebra: a graduate course}. Estados Unidos: Editorial Pacific Grove (1940).
	\bibitem{bib:groupBook} HANS, Zassenhaus. \textit{The theory of groups}. Estados Unidos: Chelsea publishing company.(1937)
	\bibitem{bib:codeBook} IAN, Blake. \textit{The mathematical theory of coding}. Estados Unidos: Academic Press Inc. (1975).
	\bibitem{bib:Jeanings} ARTHUR, Jennings. \textit{The structure of the group ring of a p-group over a modular field}. Trans. Amer. Math. Soc. 50 (1941), 175-185.
	\bibitem{bib:Deskins}EUGENE, Deskins. \textit{Finite abelian groups with isomorphic group algebras}. Duke Math. J. 23 (1956), 35-40.
	\bibitem{bib:Connell} IAN, Connell. \textit{On the group ring}. Can. J. Math. 15 (1963), 650-685.
	\bibitem{bib:PerlisWalker} PERLIS, Sam; WALKER, Gordon. \textit{Abelian group algebras of finite order}. Trans. Amer. Math. Soc. 68 (1950), p. 420-426.
\end{thebibliography}
